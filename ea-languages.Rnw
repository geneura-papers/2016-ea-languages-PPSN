...
\begin{figure}[h!tb]
  \centering
<<results-bf, cache=FALSE,echo=FALSE, dev='png'>>=
...
\begin{figure}[h!tb]
  \centering
<<results-xo, cache=FALSE,echo=FALSE, dev='png'>>=
colourCount = length(unique(measures.bf$languagerepresentation))
getPalette = colorRampPalette(brewer.pal(9, "Set1"))
...
\begin{figure}[h!tb]
  \centering
<<results-mo, cache=FALSE,echo=FALSE, dev='png'>>=
...
\begin{figure*}[h!tb]
  \centering
<<results-ops-ratios,message=FALSE, cache=FALSE,echo=FALSE, dev='png'>>=
...
\begin{figure*}[h!tb]
  \centering
<<results-ratios,message=FALSE, cache=FALSE,echo=FALSE, dev='png'>>=
...
\begin{figure*}[h!tb]
  \centering
<<results-ranks-ops,message=FALSE, cache=FALSE,echo=FALSE, dev='png'>>=
...
\begin{figure*}[h!tb]
  \centering
<<results-ranks,message=FALSE, cache=FALSE,echo=FALSE, dev='png'>>=
