...
\cite{DBLP:conf/evoW/MereloCBRGFRV16ANONYMOUS} and several data
...
operators. 
%At any rate,    [I do not understand the "At any rate..." at the begining of this sentence] 
In any case, this study shows that it is always sensible to    %["it is sensible" ?  what is sensible?]
