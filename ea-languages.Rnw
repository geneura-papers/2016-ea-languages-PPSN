...
\title{Ranking the performance of compiled and interpreted languages in genetic algorithms} 

\author{\authorname{Juan-Julián Merelo-Guervós, Israel Blancas-Álvarez, Pedro A. Castillo, Gustavo Romero, Pablo Garc{\'ia}-S{\'a}nchez\sup{1}, 
%     Victor M. Rivas \sup{2}, Mario García-Valdez, Amaury Hernández-Águila \sup{3}, Mario Román \sup{4}}
%\affiliation{\sup{1}CITIC and Computer Architecture and Technolo%gy Department,  University of Granada (Spain),   Email: (jmerelo,iblancasa,pacv,gustavo,pablogarcia)@ugr.es
}
...
\keywords{Bench\-marking, implementation of evolutionary algorithms, OneMax, genetic operators, programming languages.}
