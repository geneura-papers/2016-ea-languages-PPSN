...
\title{Ranking programming languages in evolutionary algorithm operations} 

% \author{\authorname{Juan-Julián Merelo-Guervós, Israel Blancas-Álvarez, 
%     Pedro A. Castillo, Gustavo Romero, Pablo Garc{\'ia}-S{\'a}nchez\sup{1}, 
%     Victor M. Rivas\sup{2}, 
%     Mario García-Valdez, Amaury Hernández-Águila\sup{3}, 
%     Mario Román\sup{4}}
% \affiliation{\sup{1}CITIC and Computer Architecture and Technology Department,  University of Granada (Spain),   Email: (jmerelo,iblancasa,pacv,gustavo,pablogarcia)@ugr.es}
% \affiliation{\sup{2}Department of Computer Sciences, University of Jaén (Spain), Email: vrivas@ujaen.es}
% \affiliation{\sup{3}Tijuana Institute of Technology (Mexico),Email: {amherag,mario}@tectijuana.edu.mx}\affiliation{\sup{4}University of Granada (Spain),Email: mromang08@correo.ugr.es }
% }

\author{\authorname{A. U. Thorone, A. U. Thortwo, A. Uthorthree \sup{1}, 
    A. Notherone\sup{2}, 
    Thad Sit\sup{3}, 
    Lars One\sup{4}}
\affiliation{\sup{1}Great Institute of Stuff}
\affiliation{\sup{2}Univerity of Best}
\affiliation{\sup{3}Research Center of Stuff}
\affiliation{\sup{4}University of Evenbetter}
}
...
\abstract{Despite the existence and popularity of many new and
